...
export default function TravelPlans() {
  ...
  return (
    <section className="flex flex-col min-h-[80svh] bg-yellow-500">
      ...
      <div className="flex-1 relative flex-col bg-red-500 w-full p-4">
        <Image
        ...
        />
        <div
          className={`${styles.glassCard} caption absolute bottom-0 left-0 w-full  z-[2] bg-red-500 p-4`}
        >
