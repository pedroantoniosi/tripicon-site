      ...
      <div className="overflow-hidden" ref={emblaRef}>
        <div className="flex gap-4">
          {noticias.map((item, index) => (
            <div
              key={index}
              className="min-w-[100%] sm:min-w-[50%] lg:min-w-[33.33%] gap-2"
            >
              <div className="bg-white shadow-lg rounded-2xl overflow-hidden flex flex-col h-full p-2">
                <img
                  src={item.image}
                  alt={item.title}
                ...
                <div className="p-3 flex flex-col justify-between flex-1 bg-red-500">
