          ...
          {noticias.map((item, index) => (
            ...
            >
              <div className="shadow-lg rounded-2xl overflow-hidden flex flex-col h-full">
                ...
                <div className="p-3 flex flex-col justify-start flex-1 content-start bg-red-400">
                  <h2 className="text-lg font-bold mb-3">{item.title}</h2>

                  <button
                    onClick={() => (window.location.href = item.url)}
                    className="w-100 max-w-[200px] mx-auto bg-orange-400 text-white py-2 px-4  hover:opacity-80 cursor-pointer"
                  >
                    Ver mais
                  </button>
                </div>
