...
export default function JapanCarousel() {
  ...
  return (
    <div className="w-full mx-auto bg-red-500 content-center items-center">
      {/* NAV */}
              ...
              <div className="shadow-lg rounded-2xl overflow-hidden flex flex-col h-full">
                ...
                <div className="p-3 flex flex-col justify-between flex-1">
                  ...
                  <button
                    ...
                    className="mt-auto bg-orange-400 text-white py-2 px-4  hover:opacity-80 cursor-pointer"
                  >
                    Ver mais
                  </button>
                </div>
