...
export default function Home() {
  return (
    <>
      ...
      <Container>
        <section
          className={`${styles.featuresContainer} flex flex-col p-2 gap-2 lg:p-6 lg:gap-6`}
        >
          {Array.from({ length: 6 }).map((_, index) => (
            <div
              key={index}
              className={`${styles.card} flex gap-2 lg:flex-col`}
            >
              <Image
                className="max-w-[100px] lg:max-w-[unset] rounded-2xl"
                src="/images/banner.png"
                alt="Banner"
                width={500}
                height={300}
              />
              <div className={`${styles.caption} md:content-end`}>
                <h2 className="font-bold font">
                  Lorem ipsum dolor sit amet consectetur.
                </h2>
                <p className="text-neutral-400 max-w-[500px]">
        ...
        {/* <section className="p-2 lg:p-8">
          <h2 className="font-bold text-3xl py-2">Conheça Nossas Viagens</h2>
          <div>
            <Slider
              data={trips}
              slidesPerView={{
        ...
        {/* Sessão de planos de viagens */}
        {/* <section className="p-2 lg:p-8">
          <h2 className="font-bold text-3xl py-2">Escolha sua nova aventura</h2>
          <div>
            <Slider
              data={trips}
              slidesPerView={{
