...
export default async function Home() {
  ...
  return (
    <>
      ...
      <section
        className={`${styles.discoverContainer} flex flex-col md:flex-row nd:align-content: center; md:justify-between rounded-2xl`}
      >
        <Image src="/images/discover.png" alt="" width={400} height={"auto"} />
