  ...
  return (
    <>
      ...
      <section className={styles.heroContainer}>
        <div className={`${styles.heroCaption} flex flex-col gap-6`}>
      ...
      <Container>
        <section
          className={`${styles.featuresContainer} grid grid-cols-2 gap-2 lg:grid-cols-3 lg:py-4`}
        >
        ...
        <section
          className={`${styles.discoverContainer} flex gap-2 justify-around items-center`}
        >
          ...
          <div className="flex flex-col gap-8">
            ...
            <button className="rounded bg-amber-50 text-black outline-none border-none p-3 max-w-[200px] m-auto w-100 font-bold hover:bg-neutral-200 cursor-pointer">
              Explore
            </button>
          </div>
        </section>
