...
export default function Home() {
  return (
    <>
      ...
      <Container>
        <section
          className={`${styles.featuresContainer} grid grid-cols-2 md:grid-cols-1 md:flex md:flex-col p-2 gap-2 lg:p-6 lg:gap-6`}
        >
          {Array.from({ length: 6 }).map((_, index) => (
            <div key={index} className={`${styles.card} flex gap-2 `}>
              <Image
                className=" lg:max-w-[unset] rounded-2xl"
                src="/images/banner.png"
                alt="Banner"
                width={500}
                height={300}
              />
              <div className={`${styles.caption} md:content-end p-2`}>
