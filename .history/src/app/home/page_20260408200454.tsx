...
export default async function Home() {
  ...
  return (
    <>
      ...
      <section
        className={`${styles.discoverContainer} flex flex-col md:flex-row md:align-content center; md:justify-around rounded-2xl  p-4`}
      >
        <Image src="/images/discover.png" alt="" width={400} height={0} />
        <div className="flex flex-col bg-red-500 content-center justify-center">
