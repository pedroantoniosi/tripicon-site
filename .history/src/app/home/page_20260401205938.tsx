...
export default function Home() {
  return (
    <>
      ...
      {/* Sessão de Novidades */}
      <Container>
        <section className={${styles.featuresContainer}`flex flex-col p-2 gap-2 lg:p-6 lg:gap-6`}>
          {Array.from({ length: 6 }).map((_, index) => (
            <div key={index} className="card flex gap-2 lg:flex-col">
              <Image
                className="max-w-[150px] lg:max-w-[unset] rounded-2xl"
