    ...
    <>
      <div className={styles.heroContainer}>
        <div className={`${styles.heroCaption} col gap-2`}>
          ...
          <p className="text-md lg:text-2xl text-center m-[3rem]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-[2rem] p-[1rem]">
        {Array.from({ length: 4 }).map((_, index) => (
          <div key={index} className="flex gap-[.5rem]">
            <img
              className="max-w-[100px] lg:max-w-[20vw]"
              src="/images/banner.png"
              alt=""
            />
            <div className="caption md:content-center">
