...
export default function Home() {
  return (
    <>
      ...
      <Container>
        <section
          className={`${styles.featuresContainer} grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 p-2 gap-2 lg:p-6 lg:gap-6`}
        >
          {Array.from({ length: 6 }).map((_, index) => (
            <div
              key={index}
              className={`${styles.card} flex md:flex-col gap-2 `}
            >
              <Image
