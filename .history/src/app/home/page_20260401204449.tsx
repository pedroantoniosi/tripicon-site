...
export default function Home() {
  return (
    <>
      ...
      {/* Sessão de Novidades */}
      <Container>
        <section className="flex flex-wrap p-2 gap-2 lg:p-6 lg:gap-6">
        ...
        <section className="p-2 lg:p-8">
          <h2 className="font-bold text-3xl py-2">Conheça Nossos Planos</h2>
          <div>
            <Slider
              data={trips}
              slidesPerView={{
        ...
        {/* Sessão de planos de viagens */}
        <section className="p-2 lg:p-8">
          <h2 className="font-bold text-6xl py-2">
            Os melhores hotéis para sua estadia
          </h2>
          <div>
            <Slider
              data={trips}
