...
export default async function Home() {
  ...
  return (
    <>
      ...
      <section
        className={`${styles.discoverContainer} flex-col md:flex-row nd:content-center gap-2 justify-around items-center rounded-2xl`}
      >
        <Image src="/images/discover.png" alt="" width={400} height={100} />
