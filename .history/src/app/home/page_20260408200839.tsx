...
export default async function Home() {
  ...
  return (
    <>
      ...
      <section className={`bg-amber-500 flex `}>
        <Image src="/images/discover.png" alt="" width={300} height={0} />
        <div className="bg-red-500 flex flex-col content-center justify-center">
          <h2 className="text-xl  lg:text-4xl  text-center">
            Lorem ipsum dolor sit amet consectetur.
          </h2>
          <button className="rounded bg-amber-50 text-black outline-none border-none p-3 max-w-[200px] font-bold hover:opacity-80 cursor-pointer">
            Explore
          </button>
        </div>
      </section>
